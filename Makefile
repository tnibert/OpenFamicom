...
TESTOBJS = tests/runalltests.cpp tests/testopcodes.cpp tests/testbasiccpuoperations.cpp system.cpp 6502.cpp cartridge.cpp memory.cpp opcodes.cpp sharedinstruct.cpp addressingmodes.cpp flags.cpp
#
all:
